<template>
  <Transition>
    ...
    >
      <div class="flex flex-row flex-wrap sm:flex-nowrap justify-start px-4"
           :class="{
            'py-2': queryBuilderProps.hasFilters || queryBuilderProps.globalSearch || canBeReset || queryBuilderProps.hasSearchInputs || queryBuilderProps.hasToggleableColumns || queryBuilderProps.hasSearchInputsWithValue
           }">
